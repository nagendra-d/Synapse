...
export default class CollapsibleToolbar extends Component<PropTypes> {
  public statusBarHeight: number;
  public navBarHeight: number;
  public maxScrollableHeight: number;
  public scrollOffsetY: Animated.Value;
  public toolBarOpacity: Animated.AnimatedInterpolation;
  public toolBarOverlayOpacity: Animated.AnimatedInterpolation;
  public navBarOpacity: Animated.AnimatedInterpolation;
  public navBarOverlayOpacity: Animated.AnimatedInterpolation;

  constructor(props: PropTypes) {
    super(props);

    const APPBAR_HEIGHT = Platform.OS === 'ios' ? 110 : 110;
    const ANDROID_STATUS_BAR_HEIGHT = props.translucentStatusBar
      ? StatusBar.currentHeight
      : 0;

    this.statusBarHeight = (Platform.OS === 'ios'
      ? ifIphoneX(44, 20)
      : ANDROID_STATUS_BAR_HEIGHT) as number;
...
type PropTypes = {
  ...
  imageSource?: string;
  onContentScroll?: (e: NativeSyntheticEvent<ScrollViewProps>) => void;
